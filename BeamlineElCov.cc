...
void BeamlineElCov() {
    ...
    while (true) {
        ...
        if (totalTaggedProtons > 0) {
            ...
            if (ev.truthPrimaryPDG == 11) {
                PionAbsKEUnivs[0]->Fill(energyAtVertex, -ELECTRON_COMP_UNC * ev.weight); 
                PionAbsKEUnivs[1]->Fill(energyAtVertex, +ELECTRON_COMP_UNC * ev.weight);
            }
            ...
            if (ev.backgroundType == 0 || ev.backgroundType == 1) {
                ...
                if (ev.truthPrimaryPDG == 11) {
                    PionAbsKEBkgUnivs[0]->Fill(energyAtVertex, -ELECTRON_COMP_UNC * ev.weight);
                    PionAbsKEBkgUnivs[1]->Fill(energyAtVertex, +ELECTRON_COMP_UNC * ev.weight);
                }
            }
    ...
    std::vector<TString> TwoDTitles = {
        ...
        "BeamlineEl/AbsCovariance",
        "BeamlineEl/AbsFracCovariance",
        "BeamlineEl/AbsCorrelation",
    ...
    TFile* saveFile = new TFile("/exp/lariat/app/users/epelaez/analysis_abs_scatt/histos/beamlineel/Measure.root", "RECREATE");
    saveFile->cd();
