...
void BeamlineMuCov() {
    ...
    std::vector<TString> TwoDTitles = {
        ...
        "BeamlineMu/Abs0pCovariance",
        "BeamlineMu/Abs0pFracCovariance",
        "BeamlineMu/Abs0pCorrelation",
        "BeamlineMu/AbsNpCovariance",
        "BeamlineMu/AbsNpFracCovariance",
    ...
    TFile* saveFile = new TFile("/exp/lariat/app/users/epelaez/comps/analysis1/histos/beamlinemu/Measure.root", "RECREATE");
    saveFile->cd();
