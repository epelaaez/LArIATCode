...
void GeneratorCov() {
    ...
    for (Int_t i = 0; i < NumEntries; ++i) {
        ...
        //     if (avg > 5) {
        //         std::cout << "Event " << event << " with type " << backgroundType << " has very high average weight of " << avg << std::endl;
        //         std::cout << " Num secondary interactions: " << secondaryInteractionTypes->size() << std::endl;
        //         for (int iInteraction = 0; iInteraction < secondaryInteractionTypes->size(); ++iInteraction) {
        //             std::cout << "  Interaction " << iInteraction << ": type " << secondaryInteractionTypes->at(iInteraction) << ", angle " << secondaryInteractionAngle->at(iInteraction) << ", interacting KE " << secondaryInteractionInteractingKE->at(iInteraction) << std::endl;
        //         }
        //         std::cout << std::endl;
        //     }
        // }
