...
void GeneratorCov() {
    ...
    while (true) {
        ...
        if (ev.backgroundType == 0 || ev.backgroundType == 1) {
            ...
            for (int iUniv = 0; iUniv < NUM_UNIVERSES; ++iUniv) TruePionAbsKEUnivs[iUniv]->Fill(ev.truthPrimaryVertexKE * 1000, evt_weights->at(iUniv) * ev.weight);
        ...
        if (totalTaggedPions > 0) {
            ...
            if (ev.backgroundType == 0 || ev.backgroundType == 1) {
                if (TrueEnergyBin != -1) TrueAbsAsByBinNom.at(TrueEnergyBin).at(1)->Fill(energyAtVertex, ev.weight);
            } else if (ev.backgroundType == 6 || ev.backgroundType == 12) {
            ...
            for (int iUniv = 0; iUniv < NUM_UNIVERSES; ++iUniv) {
                ...
                if (ev.backgroundType == 0 || ev.backgroundType == 1) {
                    if (TrueEnergyBin != -1) TrueAbsAsByBinUnivs.at(iUniv).at(TrueEnergyBin).at(1)->Fill(energyAtVertex, evt_weights->at(iUniv) * ev.weight);
                } else if (ev.backgroundType == 6 || ev.backgroundType == 12) {
        ...
        if (totalTaggedProtons > 0) {
            ...
            if (ev.backgroundType == 0 || ev.backgroundType == 1) {
                if (TrueEnergyBin != -1) TrueAbsAsByBinNom.at(TrueEnergyBin).at(0)->Fill(energyAtVertex, ev.weight);
            } else if (ev.backgroundType == 6 || ev.backgroundType == 12) {
            ...
            for (int iUniv = 0; iUniv < NUM_UNIVERSES; ++iUniv) {
                PionAbsKEUnivs[iUniv]->Fill(energyAtVertex, evt_weights->at(iUniv) * ev.weight);
                if (ev.backgroundType == 0 || ev.backgroundType == 1) {
                    if (TrueEnergyBin != -1) TrueAbsAsByBinUnivs.at(iUniv).at(TrueEnergyBin).at(0)->Fill(energyAtVertex, evt_weights->at(iUniv) * ev.weight);
                } else if (ev.backgroundType == 6 || ev.backgroundType == 12) {
                    ...
                    PionAbsKEBkgUnivs[iUniv]->Fill(energyAtVertex, evt_weights->at(iUniv) * ev.weight);
                }
            }
            continue;
        }
