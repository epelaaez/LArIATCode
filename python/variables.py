...
bdt_import_variables = [
    ...
    "secondaryInteractionTypes", # secondary interactions after scattering
    "secondaryInteractionAngle", # secondary interactoin angle after scattering
    "truthScatteringAngle",      # angle for inelastic scatterings
    "trajectoryInteractionAngle" # angle for elastic scatterings
]
